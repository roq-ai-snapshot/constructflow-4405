  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience ConstructFlow: Streamlining Construction Management with Real-Time Tracking, AI-Powered Predictions, and Seamless Collaboration for Unparalleled Efficiency and Cost Savings."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Experience ConstructFlow: Streamlining Construction Management with Real-Time Tracking, AI-Powered Predictions, and Seamless Collaboration for Unparalleled Efficiency and Cost Savings.`}
            </Text>
